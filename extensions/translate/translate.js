(function() {
    ...
    translate.prototype = {
        ...
        generateTransContanier: function() {
            var container = "<div class='translate-yd'><div class='translate-container'>" +
                "<div class='translate-content'><span class='translate-text'></span><span class='translation'></span></div>" +
        ...
        init: function() {
            this.generateTransContanier().initEvent(document.body);
        }
    }
